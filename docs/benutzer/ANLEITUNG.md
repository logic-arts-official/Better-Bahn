...
1. Gehen Sie zur [GitHub Releases-Seite](https://github.com/logic-arts-official/Better-Bahn/releases)
...
Derzeit ist keine iOS-Version verfügbar. Falls Sie die App erfolgreich für iOS kompilieren können, melden Sie sich gerne, und wir werden die iOS-Version offiziell bereitstellen.
...
3. Installieren Sie die Abhängigkeiten: `uv sync`
4. Führen Sie Befehle mit `uv run main.py [optionen] <url>` aus

#### Schnellstart:
```bash
# Grundlegende Nutzung
uv run main.py "https://www.bahn.de/buchung/start?vbid=IHR_LINK_HIER"

# Mit BahnCard 25, 2. Klasse
uv run main.py --bahncard BC25_2 "IHR_DB_LINK"

# Mit Deutschland-Ticket
uv run main.py --deutschland-ticket "IHR_DB_LINK"

# Benutzerdefiniertes Alter und vollständige Optionen
uv run main.py --age 25 --bahncard BC50_1 --deutschland-ticket "IHR_DB_LINK"
```
